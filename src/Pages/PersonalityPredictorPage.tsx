        ...
        <div className="text-center my-5 ">
            ...
            <h2>What It Does</h2>
                ...
                <p className="mb-6 text-lg text-gray-800 leading-relaxed">
                    ...
                    given the situational settings you input. These are to emulate one's upbringing and the pattern of behaviors that are developed by these
            ...
            <h2>Future Plan</h2>
            <p className="mb-6 text-lg text-gray-800 leading-relaxed">
                Future plan will expand beyond these 5 actions and 3 stiuations. More in-depth analysis will be placed on 
